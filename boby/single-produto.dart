...
class _ProdutoState extends State<Produto> {
                  ...
                  child: Swiper(
                    ...
                    itemBuilder: (BuildContext context, int index) {
                      return Container(
                        ...
                        padding: EdgeInsets.all(10.0),
                        child: Image.network(
                          "http://rochaapp.com.br/imagens/${fotos[index]["foto"]}",
                          fit: BoxFit.fill,
                        ),
                      );
                    },
  ...
  void getProdutos(String id) async {
    http.Response request = await http.get(
        "http://rochaapp.com.br/api/api.php?selecionarprodutoApi&id=${id}");
    produtos = json.decode(request.body);
  }

  void getFotos(String id) async {
    http.Response request = await http.get(
        "http://rochaapp.com.br/api/api.php?selecionarTodasfotosProdutoApi&id_produto=${id}");
    fotos = json.decode(request.body);
  }

  void getAppDados() async {
    http.Response request =
        await http.get("http://rochaapp.com.br/api/api.php?selecionarAppApi");
